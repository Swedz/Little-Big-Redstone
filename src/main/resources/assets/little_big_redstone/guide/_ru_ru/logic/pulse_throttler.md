...
<FloatingColumn width="100" align="right">
	### Аналоговый
    Ограничители импульсов по умолчанию выдают выходной сигнал той же силы, что и входной. 
    Если сила сигнала задана, выходной сигнал всегда будет иметь это постоянное значение.
</FloatingColumn>
