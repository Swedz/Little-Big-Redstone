...
<FloatingColumn width="100" align="right">
	### Аналоговый
	В режиме компаратора считыватель выдаёт сигнал той же силы, что и аналоговый сигнал, который блок выдаёт компаратору. 
    В остальных случаях считыватели всегда выдают только значение 0 (ВЫКЛ) или 1 (ВКЛ).
</FloatingColumn>
...
Считыватель можно настроить на определённый порог содержимого контейнера для выдачи сигнала ВКЛ.
Этот порог может быть процентом или постоянным значением. Чтобы использовать процент, просто добавьте % в конце значения.
