...
<FloatingColumn width="100" align="right">
    ### Аналоговый
	Вентили ИСКЛЮЧАЮЩЕЕ ИЛИ выдают выходной сигнал, равный наибольшей силе входного сигнала.
...
<Row>
    <Column>
       <Recipe id="little_big_redstone:logic/xor_gate" />
    </Column>
...
Вентили ИСКЛЮЧАЮЩЕЕ ИЛИ — это логические компоненты, которые выдают сигнал ВКЛ только тогда, когда включено нечётное количество входов. 
В случае простого вентиля ИСКЛЮЧАЮЩЕЕ ИЛИ с двумя входами это означает, что выход будет ВКЛ только тогда, когда включён ровно один из входов.

Вентили ИСКЛЮЧАЮЩЕЕ ИЛИ можно настроить на любое количество входов от 2 до 10.
