...
<FloatingColumn width="100" align="right">
    ### Булевый
	Вентили И-НЕ всегда выдают только значение 0 (ВЫКЛ) или 1 (ВКЛ).
...
Вентиль И-НЕ — это логический компонент, который выводит сигнал ВЫКЛ только когда **все** его входы находятся в состоянии ВКЛ.  
Это обратная операция по отношению к [Вентилю И](and_gate.md).

Вентиль И-НЕ можно настроить на работу с 2–10 входами.
