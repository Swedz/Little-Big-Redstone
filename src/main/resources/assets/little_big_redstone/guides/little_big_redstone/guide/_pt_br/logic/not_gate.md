...
<Row>
	<Column>
		<Recipe id="little_big_redstone:logic/not_gate" />
	</Column>
...
Portas NOT são a porta mais simples disponível. Elas aceitam uma única entrada, invertem o sinal e fornecem uma única saída.
