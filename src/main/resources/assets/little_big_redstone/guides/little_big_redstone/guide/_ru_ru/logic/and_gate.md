...
<FloatingColumn width="100" align="right">
	### Аналоговый
	Вентили И выдают выходной сигнал, равный наибольшей силе входного сигнала.
...
<Row>
	<Column>
		<Recipe id="little_big_redstone:logic/and_gate" />
	</Column>
...
Вентиль И — это логический компонент, который выводит сигнал ВКЛ только когда все его входы находятся в состоянии ВКЛ. 
Это обратная операция по отношению к [Вентилю И-НЕ](nand_gate.md).

Вентиль И можно настроить на работу с 2–10 входами.
