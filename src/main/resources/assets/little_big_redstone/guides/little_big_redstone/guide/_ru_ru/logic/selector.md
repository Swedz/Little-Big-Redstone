...
<FloatingColumn width="100" align="right">
	### Аналоговый
	Селекторы выдают выходной сигнал той же силы, что и входной. 
    В режиме счётчика для силы выходного сигнала используется наибольшая сила сигнала между входами увеличения и уменьшения.

    Кроме того, если селектор настроен не пропускать сигнал, сила выходного сигнала будет равна номеру выхода, начиная с 1. 
    Например, первый выход выдаст сигнал силой 1, второй - 2, третий - 3 и т.д.
</FloatingColumn>
