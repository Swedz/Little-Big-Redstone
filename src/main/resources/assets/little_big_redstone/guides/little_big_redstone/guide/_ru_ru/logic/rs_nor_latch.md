...
Вход A, или вход «Установка», при включении переводит выход в состояние ВКЛ, и он остаётся в этом состоянии даже после выключения A. 
Любые последующие включения входа A не изменят выход, пока он находится в состоянии ВКЛ.

Вход B, также известный как вход «Сброс», при включении установит выход в состояние ВЫКЛ, и он остаётся в этом состоянии даже после выключения B — при условии, что A также выключен. 
