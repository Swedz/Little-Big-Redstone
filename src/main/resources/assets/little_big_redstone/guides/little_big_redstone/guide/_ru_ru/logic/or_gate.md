...
<FloatingColumn width="100" align="right">
    ### Аналоговый
	Вентили ИЛИ выдают выходной сигнал, равный наибольшей силе входного сигнала.
...
<Row>
	<Column>
		<Recipe id="little_big_redstone:logic/or_gate" />
	</Column>
...
Вентиль ИЛИ — это логический компонент, который выводит сигнал ВКЛ, когда хотя бы один из входов находится в состоянии ВКЛ.  
Это обратная операция по отношению к [Вентилю ИЛИ-НЕ](nor_gate.md).

Поскольку порты ввода могут принимать только один провод, вентиль ИЛИ используется для объединения нескольких проводов в один порт.

Вентиль ИЛИ можно настроить на работу с 2–10 входами.
