...
<FloatingColumn align="right">
	<PaddedBox left="5">
		<Recipe id="little_big_redstone:microchip/red" />
	</PaddedBox>
</FloatingColumn>
...
В меню микрочипов вы можете приближать и отдалять его содержимое с помощью прокрутки колёсика мыши. Удерживая левую кнопку мыши и перетаскивая, вы сможете перемещать область просмотра схемы.
