package net.swedz.redstone_circuitry.datagen.client;

import net.minecraft.data.DataProvider;
import net.neoforged.neoforge.data.event.GatherDataEvent;
import net.swedz.redstone_circuitry.datagen.client.provider.LanguageDatagenProvider;
import net.swedz.redstone_circuitry.datagen.client.provider.models.BlockModelsDatagenProvider;
import net.swedz.redstone_circuitry.datagen.client.provider.models.ItemModelsDatagenProvider;
