...
{
	public static final ResourceLocation BACKGROUND         = RedstoneCircuitry.id("textures/logic/background.png");
	public static final ResourceLocation BACKGROUND_OVERLAY = RedstoneCircuitry.id("textures/logic/background_overlay.png");
