...
public final class LogicTypeDeferredRegister extends DeferredRegister<LogicType>
{
	...
	@Override
	public <I extends LogicType> DeferredLogicType<I> register(String name, Function<Identifier, ? extends I> func)
	{
		return (DeferredLogicType<I>) super.register(name, func);
	}
	
	@Override
	protected <I extends LogicType> DeferredLogicType<I> createHolder(ResourceKey<? extends Registry<LogicType>> registryKey, Identifier key)
	{
