package net.swedz.little_big_redstone.microchip.logic.randomizer;
...
public final class LogicRandomizerConfig extends LogicConfig<LogicRandomizerConfig>
{
	...
	{
		builder.addSlider(LBRText.LOGIC_CONFIG_BUTTON_LABEL_OUTPUTS.text(), Component.empty(), LBRText.LOGIC_CONFIG_BUTTON_TOOLTIP_OUTPUTS.text(), 0, 0, 160, 18, this.outputsAllowed().min(), this.outputsAllowed().max(), outputs, 1, 0, true, (value) -> outputs = value.intValue());
