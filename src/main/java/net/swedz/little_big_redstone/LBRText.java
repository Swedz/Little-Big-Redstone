...
public enum LBRText implements TranslatableTextEnum
{
	...
	LOGIC_CONFIG_BUTTON_TOOLTIP_IO_COMPARISON_MODE_EQUAL_TO("The input signal must be equal to %s."),
	LOGIC_CONFIG_BUTTON_TOOLTIP_IO_COMPARISON_MODE_GREATER_THAN_OR_EQUAL_TO("The input signal must be greater than or equal to %s."),
	LOGIC_CONFIG_BUTTON_TOOLTIP_IO_COMPARISON_MODE_LESS_THAN_OR_EQUAL_TO("The input signal must be less than or equal to %s."),
	...
	LOGIC_CONFIG_TOOLTIP_IO_COMPARISON_MODE("  Comparison: %s"),
